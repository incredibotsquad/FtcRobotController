...
@Config
@Autonomous(name = "IncredibotsAuto2SpecimenBlue", group = "Autonomous")
 ...
 */
public class IncredibotsAuto2SpecimenBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action pickSampleOne = drive.actionBuilder(INIT_POS)
                .strafeToConstantHeading(GET_CLOSE_TO_FIRST_SAMPLE.position)
