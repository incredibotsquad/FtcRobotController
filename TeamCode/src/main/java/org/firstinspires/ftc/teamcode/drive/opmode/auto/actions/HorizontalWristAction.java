...
public class HorizontalWristAction implements Action {
    ...
    public HorizontalWristAction(RobotHardware robotHardware, double position, boolean waitForAction, boolean shortWait) {
    ...
    public boolean run (@NonNull TelemetryPacket packet) {
        if (!initialized) {
            ...
            robotHardware.setHorizontalWristServoPosition(position);
            initialized = true;
        }
        ...
        if (waitForAction) {
            ...
            return (robotHardware.getHorizontalWristServoPosition() != position);
        }
