...
@Config
@Autonomous(name = "NewRedAuto6Ball", group = "Autonomous")
public class NewRedAuto6Ball extends BaseAuto {
    ...
    public void runOpMode() {
        ...
        Log.w("NewRedAuto6Ball", "total time: " + totalTime.milliseconds());
        // Cleanup
...
//        robotHardware.stopLimelight();
    ...
    private void CheckForBallsToIntake() {
        if (currentState == AutoState.INTAKE_BALLS_1 && intakeSystem.isOn && !spindex.isFull()) {
    ...
    private void processState() {
        ...
        if (stateTimer.milliseconds() > getTimeoutForState(currentState)) {
            Log.w("NewRedAuto6Ball", "State timeout! Advancing from: " + currentState);
            advanceToNextState();
            return;
        }
        ...
        switch (currentState) {
            ...
            case DRIVE_TO_LAUNCH_PRELOAD:
                Log.i("NewRedAuto6Ball", "Starting DRIVE_TO_LAUNCH_PRELOAD");
                runningActions.add(
                        new ParallelAction(
            ...
            case LAUNCH_ALL_PRELOAD:
                Log.i("NewRedAuto6Ball", "Starting LAUNCH_ALL_PRELOAD");
            ...
            case DRIVE_TO_INTAKE_1:
                Log.i("NewRedAuto6Ball", "Starting DRIVE_TO_INTAKE_1");
                runningActions.add(
                        new ParallelAction(
                                mecanumDrive.actionBuilder(mecanumDrive.localizer.getPose())
            ...
            case INTAKE_BALLS_1:
                Log.i("NewRedAuto6Ball", "Starting INTAKE_BALLS_1");
            ...
            case DRIVE_TO_LAUNCH_1:
                Log.i("NewRedAuto6Ball", "Starting DRIVE_TO_LAUNCH_1");
                runningActions.add(
                        new ParallelAction(
                                mecanumDrive.actionBuilder(mecanumDrive.localizer.getPose())
            ...
            case LAUNCH_ALL_1:
                Log.i("NewRedAuto6Ball", "Starting LAUNCH_ALL_1");
                runningActions.add(
                        launchSystem.getBallPatternLaunchAction(pattern)
                );
                stateTransitionInProgress = true;
            ...
            case MOVE_AWAY_FROM_LINE:
                Log.i("NewRedAuto6Ball", "Starting MOVE_AWAY_FROM_LINE");
                runningActions.add(
                        mecanumDrive.actionBuilder(mecanumDrive.localizer.getPose())
            ...
            case DONE:
                Log.i("NewRedAuto6Ball", "Auto complete!");
                break;
        }
    }
    ...
    private void advanceToNextState() {
        ...
        Log.i("NewRedAuto6Ball", "Advanced to state: " + currentState);
    }
