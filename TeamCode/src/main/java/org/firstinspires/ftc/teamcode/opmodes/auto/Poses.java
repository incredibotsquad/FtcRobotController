...
public class Poses {
    ...
    public final Pose NEAR_INIT, NEAR_FINAL_LAUNCH, NEAR_1_PATH_GATE_INTAKE, NEAR_GATE_JIGGLE_BACKWORD_POSE, NEAR_OPEN_GATE_CONTROL, NEAR_OPEN_GATE, NEAR_1_PATH_GATE_CONTROL_1, NEAR_1_PATH_GATE_CONTROL_2, NEAR_LAUNCH, FIRST_SPIKE, SECOND_SPIKE, NEAR_SPIKE_2_CONTROL, NEAR_HUMAN_CONTROL, NEAR_SPIKE_3_CONTROL;
    ...
    public Poses(boolean isRed) {
        ...
        NEAR_PARK = maybeMirror(new Pose(91, 85, Math.toRadians(0)), isRed);

        NEAR_OPEN_GATE = maybeMirror(new Pose(130, 73, Math.toRadians(0)), isRed);
        NEAR_OPEN_GATE_CONTROL = maybeMirror(new Pose(115, 70, Math.toRadians(0)), isRed);

        NEAR_SPIKE_2_CONTROL = maybeMirror(new Pose(90, 55), isRed);
        NEAR_SPIKE_3_CONTROL = maybeMirror(new Pose(88, 27), isRed);
        ...
        NEAR_HUMAN_CONTROL = maybeMirror(new Pose(92, 2), isRed);
    }
