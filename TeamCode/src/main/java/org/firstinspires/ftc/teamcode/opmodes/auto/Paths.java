...
public class Paths {
    ...
    public PathChain NEAR_PRELOADS, NEAR_SCORE_GATE, NEAR_GATE, NEAR_GATE_2, NEAR_SPIKE_1, NEAR_SCORE_SPIKE_1, NEAR_SPIKE_2, NEAR_SCORE_SPIKE_2, NEAR_HUMAN_PLAYER, NEAR_SCORE_HUMAN, NEAR_SPIKE_3, NEAR_SCORE_SPIKE_3, NEAR_TUNNEL, NEAR_SCORE_TUNNEL, FAR_SCORE_HUMAN, FAR_SCORE_TUNNEL, NEAR_LEAVE;
    ...
    public void buildNearPaths() {
        NEAR_PRELOADS = follower.pathBuilder()
                .addPath(new BezierLine(poses.NEAR_INIT, poses.NEAR_FIRST_SHOT))
                .setLinearHeadingInterpolation(poses.NEAR_INIT.getHeading(), poses.NEAR_FIRST_SHOT.getHeading())
                .build();

        NEAR_SPIKE_1 = follower.pathBuilder()
                .addPath(new BezierLine(poses.NEAR_FIRST_SHOT, poses.NEAR_FIRST_SPIKE))
                .setLinearHeadingInterpolation(poses.NEAR_FIRST_SHOT.getHeading(), poses.NEAR_FIRST_SPIKE.getHeading())
                .build();

        NEAR_SCORE_SPIKE_1 = follower.pathBuilder()
                .addPath(new BezierLine(poses.NEAR_FIRST_SPIKE, poses.NEAR_SHOT_POSE))
                .setLinearHeadingInterpolation(poses.NEAR_FIRST_SPIKE.getHeading(), poses.NEAR_SHOT_POSE.getHeading())
                .build();

        NEAR_SPIKE_2 = follower.pathBuilder()
                .addPath(new BezierCurve(poses.NEAR_FIRST_SHOT, poses.NEAR_SECOND_SPIKE_CONTROL, poses.NEAR_SECOND_SPIKE))
                .setLinearHeadingInterpolation(poses.NEAR_FIRST_SHOT.getHeading(), poses.NEAR_SECOND_SPIKE.getHeading())
                .build();

        NEAR_SCORE_SPIKE_2 = follower.pathBuilder()
                .addPath(new BezierLine(poses.NEAR_SECOND_SPIKE, poses.NEAR_SHOT_POSE))
                .setLinearHeadingInterpolation(poses.NEAR_SECOND_SPIKE.getHeading(), poses.NEAR_SHOT_POSE.getHeading())
                .build();

        NEAR_GATE = follower.pathBuilder()
                .addPath(new BezierLine(poses.NEAR_SHOT_POSE, poses.NEAR_GATE_POSE))
                .setLinearHeadingInterpolation(poses.NEAR_SHOT_POSE.getHeading(), poses.NEAR_GATE_POSE.getHeading())
                .build();
        ...
        NEAR_SCORE_GATE = follower.pathBuilder()
                .addPath(new BezierLine(poses.NEAR_GATE_POSE_2, poses.NEAR_SHOT_POSE))
                .setLinearHeadingInterpolation(poses.NEAR_GATE_POSE_2.getHeading(), poses.NEAR_SHOT_POSE.getHeading())
                .build();
        ...
        NEAR_LEAVE = follower.pathBuilder()
                .addPath(new BezierLine(poses.NEAR_SHOT_POSE, poses.NEAR_END_POSE))
                .setLinearHeadingInterpolation(poses.NEAR_SHOT_POSE.getHeading(), poses.NEAR_SHOT_POSE.getHeading())
                .build();
    }
