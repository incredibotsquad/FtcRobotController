...
//                .build();
    ...
    public void buildFarPaths() {
        ...
        FAR_SPIKE_3 = follower.pathBuilder()
                .addPath(new BezierCurve(poses.FAR_LAUNCH, poses.SPIKE_3_CONTROL_POSE, poses.FAR_INTAKE2_POSE))
                .setLinearHeadingInterpolation(poses.FAR_LAUNCH.getHeading(), poses.FAR_INTAKE2_POSE.getHeading())
                .build();

        FAR_SCORE_SPIKE_3 = follower.pathBuilder()
                .addPath(new BezierLine(poses.FAR_INTAKE2_POSE, poses.FAR_LAUNCH))
                .setLinearHeadingInterpolation(poses.FAR_LAUNCH.getHeading(), poses.FAR_INTAKE2_POSE.getHeading())
                .build();
