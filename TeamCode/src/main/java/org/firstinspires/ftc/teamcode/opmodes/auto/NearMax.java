...
@Configurable
@Autonomous(name = "Near Max", group = "Autonomous")
public class NearMax extends CommandOpMode {
    ...
    public Command getAutoRoutine() {
        return new SequentialCommandGroup(
                ...
                new SequentialCommandGroup(
                        new InstantCommand(() -> Log.i("Near Max", "Starting Preload and Spikes")),
                        ...
                        new InstantCommand(() -> Log.i("Near Max", "Seconds " + timer.seconds()))
                )
