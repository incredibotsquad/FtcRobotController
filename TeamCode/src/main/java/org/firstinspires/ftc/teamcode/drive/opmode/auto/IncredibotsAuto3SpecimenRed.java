...
public class IncredibotsAuto3SpecimenRed extends IncredibotsAuto {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action pickAndDropSampleOne = drive.actionBuilder(INIT_POS)
                .stopAndAdd(GetArmControlAction(IncredibotsArmControl.PICK_SAMPLE_ARM, IncredibotsArmControl.CLAW_ARM_VELOCITY, false))
        ...
        Action pickAndSnapSpecimenOne = drive.actionBuilder(DROP_FIRST_SAMPLE)
                .stopAndAdd(GetArmControlAction(IncredibotsArmControl.PICK_SPECIMEN_ARM, IncredibotsArmControl.CLAW_ARM_VELOCITY, true))
                ...
                .stopAndAdd(GetClawControlAction(false, true, false))
                .stopAndAdd(GetArmControlAction(IncredibotsArmControl.HANG_SPECIMEN_ARM, IncredibotsArmControl.CLAW_ARM_VELOCITY, false))
                ...
                .stopAndAdd(GetSlideControlAction(IncredibotsArmControl.HANG_SPECIMEN_SLIDE, true))
                .stopAndAdd(GetArmControlAction(IncredibotsArmControl.SNAP_SPECIMEN_ARM, IncredibotsArmControl.CLAW_ARM_AUTO_VELOCITY_SNAP_SPECIMEN, true))
                //.waitSeconds(0.6)
        ...
        Action pickAndSnapSpecimenTwo = drive.actionBuilder(MOVE_TO_BRACE_SUB_SPECIMEN_ONE)
                ...
                .stopAndAdd(GetArmControlAction(IncredibotsArmControl.PICK_SPECIMEN_ARM, IncredibotsArmControl.CLAW_ARM_VELOCITY, false))
