...
public class VerticalWristAction implements Action {
    ...
    public VerticalWristAction(RobotHardware robotHardware, double position, boolean waitForAction, boolean shortWait) {
    ...
    public boolean run (@NonNull TelemetryPacket packet) {
        if (!initialized) {
            ...
            robotHardware.setVerticalWristServoPosition(position);
            initialized = true;
        }
        ...
        if (waitForAction) {
            ...
            return (robotHardware.getVerticalWristServoPosition() != position);
        }
