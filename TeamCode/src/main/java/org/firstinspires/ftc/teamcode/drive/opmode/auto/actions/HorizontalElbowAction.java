...
public class HorizontalElbowAction implements Action {
    ...
    public HorizontalElbowAction(RobotHardware robotHardware, double position, boolean waitForAction, boolean shortWait) {
    ...
    public boolean run (@NonNull TelemetryPacket packet) {
        if (!initialized) {
            ...
            robotHardware.setHorizontalElbowServoPosition(position);
            initialized = true;
        }
